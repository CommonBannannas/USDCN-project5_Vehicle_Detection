...
The first for my solutions consisted of a quick explorations of the data set provided for training de SVC (Support Vector Classifier)
* Car images: 8792
* Not car images: 8968

The dataset seems balanced, but can we improve the accuracy a little bit by augmenting the non vehicle class?
I decided to give it a try and augment the data:
